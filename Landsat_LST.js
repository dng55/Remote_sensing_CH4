...
Edited by: Darian Ng
Edit: Added NDWI band calculation
...
var NDWI = require('users/DNG/gee_code:modules/compute_NDWI.js')
//Modified Normalized Difference Water Index using landsat SWIR_1
var MNDWI = require('users/DNG/gee_code:modules/compute_modified_ndwi.js')
//Modified Normalized Difference Water Index using landsat SWIR_2
var MNDWI2 = require('users/DNG/gee_code:modules/compute_modified_ndwi2.js')
// --------------------------------------------------------------------------------
exports.collection = function(landsat, date_start, date_end, geometry, use_ndvi){
  ...
  var landsatSR = ee.ImageCollection(sr_collection.getInfo())
                ...
                .map(NDWI.addBand(landsat))
                .map(MNDWI.addBand(landsat))
                .map(MNDWI2.addBand(landsat))
  // combine collections
