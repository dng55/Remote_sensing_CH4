def get_spatial(date, spatial_index,dataStruct,interval):
    """
    Grabs all satellite data for a given date
        Input: 
    ...
    """
    from lon_to_m import lon_to_m
    from lat_to_m import lat_to_m
    import numpy as np
